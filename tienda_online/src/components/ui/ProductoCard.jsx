...
export default function ProductoCard({ slug, producto, brandColor, themeKey, ctaText = 'Consultar', onWhatsAppClick }) {
  ...
  return (
    <article className={`card product-card product-card-${themeKey} group`}>
      <Link to={buildProductPath(slug, producto)} className="card-image-wrap relative block">
